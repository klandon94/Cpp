...
public:
    ...
    // returns a pointer to a new Mammal object by calling the copy constructor, passing in itself(*this) as a const reference
...
int main()
{
    ...
    for (i = 0; i < numAnimalTypes; i++)
    {
        ...
        // pointer to each object stored in array
        array[i] = ptr;
    }
    ...
    {
        array[i]->speak();
        // pointer to a copy of the object which is then stored in other Array
