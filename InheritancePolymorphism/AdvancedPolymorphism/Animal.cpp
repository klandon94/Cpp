...
{
public:
    Mammal(int newAge):Animal(newAge) {std::cout << "Mammal constructor...\n";}
    virtual ~Mammal() {std::cout << "Mammal destructor...\n";}
    // provides a common form of reproduction for all Mammal objects, so Mammal classe extensions no longer have to override this method
...
{
public:
    Fish(int newAge):Animal(newAge) {std::cout << "Fish constructor...\n";}
...
{
public:
    Horse(int newAge, COLOR newColor):Mammal(newAge), color(newColor) {std::cout << "Horse constructor...\n";}
...
{
public:
    Dog(int newAge, COLOR newColor): Mammal(newAge), color(newColor) {std::cout << "Dog constructor...\n";}
